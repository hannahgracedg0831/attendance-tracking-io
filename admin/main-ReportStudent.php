                ...
                <div class="content container-fluid">
					...
					<div class="alert alert-primary">
						...
						<div class="pull-right">
							<a href="main-ReportStudent.php" class="btn btn-warning btn-sm">&nbsp;<font color="black"><b><i class="fa fa-refresh"></i>&nbsp;Refresh Table</b></font></a>
						</div>
						...
						<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
						  <div class="btn-group" role="group">
						    ...
						    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
						    	<small><center><font color="blue"><b>CHOOSE YOUR OPTION:</b></font></center></small>
						      <a type="button" class="dropdown-item" data-toggle="modal" data-target="#studentcsv_modal" href="">CSV</a>
<!-- 						      <a type="button" class="dropdown-item" href="#">PDF</a>
 ...
 <a type="button" class="dropdown-item" data-toggle="modal" data-target="#print_modal" href="">PRINT</a>
						    </div>
						  </div>
						</div>

						<!-- Filter Data Modal -->
						<?php  $date; include '../components/modal/filterdataDate.php'; ?>
						<!-- /Filter Data Modal -->
		...
		<div id = "content">
			...
			include '../components/table/admin-tableReportStudent.php'; ?>
		</div>
