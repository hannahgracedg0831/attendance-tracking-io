	...
	<div class="sidebar-inner slimscroll">
		...
		<hr>
			...
			<li class="menu-title">
				...
				<li><a href="main-ReportVisitor.php" style="background-color: #FFA600;"><font color="black"><strong><i class="fa fa-th-large"></i> <span> Visitor</span></strong></font></a></li>
                ...
                <div class="content container-fluid">
					...
					<div class="alert alert-primary">
						...
						<div class="pull-right">
							<a href="main-ReportVisitor.php" class="btn btn-warning btn-sm">&nbsp;<font color="black"><b><i class="fa fa-refresh"></i>&nbsp;Refresh Table</b></font></a>
						</div>
						...
						<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
						  <div class="btn-group" role="group">
							...
							<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
						    	<small><center><font color="blue"><b>CHOOSE YOUR OPTION:</b></font></center></small>
						      <a type="button" class="dropdown-item" data-toggle="modal" data-target="#visitorcsv_modal" href="">CSV</a>
<!-- 						      <a type="button" class="dropdown-item" href="#">PDF</a>
 ...
 <!-- <a type="button" class="dropdown-item" href="../process/admin-exportEXCELReportstudent.php">EXCEL</a> -->
 							<a type="button" class="dropdown-item" data-toggle="modal" data-target="#visitorprint_modal" href="">PRINT</a>
						    </div>
						  </div>
						</div>
		...
		<div id = "content">
			<?php include '../components/table/admin-tableReportVisitor.php'; ?>
		</div>
