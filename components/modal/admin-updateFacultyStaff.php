<!-- Update File -->
<div class="modal fade" id="edit_modal<?php echo $fetch['staff_id']?>" aria-hidden="true">
					...
					<div class="modal-content">
						<form method="POST" action="../process/admin-update.php" autocomplete="off">	
							<div class="modal-header" style="background-color: rgba(7, 4, 112, 1);">
								<h3 class="modal-title"><font color="white"><i class="fa fa-pencil"></i>&nbsp;Update Staff</font></h3>
							</div>
							<div class="modal-body">
								<div class="col-md-12">
								<center>
									<div class="form-group">
										<input type="hidden" name="staff_id" value="<?php echo $fetch['staff_id']?>" class="form-control"/>
										<label>Staff ID</label>
										<input readonly="" name="staff_id" value="<?php echo $fetch['staff_id']?>"  class="form-control" required/>
									</div>
								</center>
								<div class="row">
									<div class="col">
								...
								<div class="row">
									...
									<div class="col">
										<div class="form-group">
											...
											<input type="text" name="position" value="<?php echo $fetch['position']?>" class="form-control" required/>
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="modal-footer">
									<button name="updateStaff" type="submit" class="btn btn-warning" ><span class="glyphicon glyphicon-save"></span> Update</button>
