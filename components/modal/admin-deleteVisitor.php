...
<!-- Delete File -->
<div class="modal fade"id="delete_modal<?php echo $fetch['visitor_id']?>"  aria-hidden="true">
	...
	<form method="POST" action="../process/admin-delete.php" autocomplete="off">
		<div class="modal-content">
			...
			<div class="modal-header" style="background-color: rgba(7, 4, 112, 1);">
				<h3 class="modal-title"><font color="white"><i class="fa fa-trash"></i>&nbsp;Delete Visitor</font></h3>
			</div>
