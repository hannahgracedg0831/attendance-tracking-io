<div id="profile_info" class="modal custom-modal fade" role="dialog">
				<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
					<div class="modal-content">
						...
						<form action="../../process/guard-changeAccount.php" method="post" enctype="multipart/form-data" autocomplete="off">
									...
									<div class="alert alert-info">
										...
										<div class="row">
											<div class="col-md-6">
													...
													<input type="file" name="" class="form-group" value="">
											</div>
											<div class="col-md-6">
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="" value="<?php echo $first; ?>">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Middle Name</label>
													<input type="text" class="form-control" name="" value="<?php echo $middle; ?>">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Last Name</label>
													<input type="text" class="form-control" name="" value="<?php echo $last; ?>">
												</div>
											</div>
											<div class="col-md-8">
												<div class="form-group">
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>Phone</label>
													<input type="text" class="form-control" name="" value="<?php echo $contact; ?>">
												</div>
											</div>
										</div>
									</div>
