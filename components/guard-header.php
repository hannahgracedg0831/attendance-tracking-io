            ...
            <div class="header shadow-5-strong" style="background-image: url('../assets/cover2.png');
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown has-arrow main-drop">
						...
						echo  $_SESSION['guard_name'];
							?></span>
						</a>
						<div class="dropdown-menu">
							<a class="dropdown-item" href="../guard/main-account.php"><i class="fa fa-user"></i> Account Setting</a>
				...
				<div class="dropdown mobile-user-menu">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a class="dropdown-item" href="../guard/main-account.php">Account Setting</a>
